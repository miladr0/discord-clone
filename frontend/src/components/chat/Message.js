...
export default function Message({
  ...
  return (
    <div
      className='flex hover:bg-discord-transparentBlack3 justify-between relative'
      onMouseEnter={() => setShowSetting(true)}
      onMouseLeave={() => setShowSetting(false)}
    >
      {isSameTimePrev ? (
        <div className='flex justify-start items-center px-4 mt-1'>
          <div className='flex'>
            <p
            ...
            <p className='text-discord-100 text-sm font-light ml-2 text-left'>
              {message}
            </p>
          </div>
        </div>
        ...
        <div
          className={classNames('flex justify-start items-center px-4', {
        ...
        >
          <div className='flex justify-center'>
            <a
              href='#'
              className='flex items-center mx-auto w-10 h-10 bg-discord-red text-white rounded-full inline-block'
            >
              <svg
          ...
          <div className='flex flex-col ml-4'>
            ...
            <div>
              <p className='text-discord-100 text-sm font-light text-left'>
                {message}
              </p>
            </div>
          </div>
      ...
      {showSetting && (
        <ul className='flex bg-discord-600 absolute -top-3 right-5 hover:shadow-md rounded-md'>
          ...
          <li className='mr-2 p-1 cursor-pointer hover:bg-discord-itemHover'>
            <HorizontalThreeDots className='w-5 h-5 text-discord-500' />
          </li>
        </ul>
      )}
    </div>
